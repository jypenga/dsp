...
class Custom():
    ...
    def RegisterTable(self):
        content = html.Table([html.Tr([html.Td(html.Img(src=self.app.get_asset_url('icon-user.svg'))), html.Td('Naam'), html.Td(dcc.Input(id='input-user', type='text'))]),
    ...
    def LoginTable(self):
        content = [html.Table([html.Tr(html.Td('Emailadres')), html.Tr(html.Td(dcc.Input(id='login-input-email', type='email')))], className='login-table'),
                html.Table([html.Tr(html.Td('Wachtwoord')), html.Tr(html.Td(dcc.Input(id='login-input-password', type='password')))], className='login-table')]
        return content
